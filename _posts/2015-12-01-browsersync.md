...
layout: post
title: Browsersync
tags: [Node, Gulp, Browsersync]
categories: [Node]
---
随着前端技术的飞速发展，前端的工程化构建工具也随着这股浪潮不断更迭，从grunt到gulp，而ant已经淹没在了潮流之中。然而，不单单是构建工具变化飞快，连构建工具的插件变化也是日新月异，最近项目使用gulp构建的过程中就尝试使用了**Browsersync**这个插件来替代gulp-livereload。
...
![官网示例1](http://upload-images.jianshu.io/upload_images/1258730-e7530edfefa1a9d6.gif?imageMogr2/auto-orient/strip)

还不仅如此，它还能**在不同的浏览器不同的设备上同步所有页面上的操作**，这绝对是多浏览器兼容性测试的福音啊！

![官网示例2](http://upload-images.jianshu.io/upload_images/1258730-8d8b9366ee8ec5c2.gif?imageMogr2/auto-orient/strip)
