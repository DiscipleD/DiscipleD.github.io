...
**"当然不是这种装饰者..."**
![当然不是这种装饰者...](http://upload-images.jianshu.io/upload_images/1258730-598d299cab611cf5.png)
...
![组件装饰设计图](http://upload-images.jianshu.io/upload_images/1258730-cc26004ff916a5b7.png)

###方法一： 闭包
我能想到最原生实现装饰者模式的方法就是用一个对象来包装需要被装饰的对象，并返回一个新对象，在这个新对象中执行一些处理后再调用原始的方法。

![简单](http://upload-images.jianshu.io/upload_images/1258730-ef8aede4440e8e23.png)
> “简单！”
...
![俄罗斯套娃](http://upload-images.jianshu.io/upload_images/1258730-9a4a0993b6683aeb.png)
...
**验证装饰器为何要设置定时？**
![服务生比喻](http://upload-images.jianshu.io/upload_images/1258730-7efb4275d77e0475.png)
...
![私有](http://upload-images.jianshu.io/upload_images/1258730-4191b400de96dd12.png)
...
![猴子](http://upload-images.jianshu.io/upload_images/1258730-276780d038c49abc.png)
...
![委托](http://upload-images.jianshu.io/upload_images/1258730-a3230ea9acbec25d.png)
...
![代理](http://upload-images.jianshu.io/upload_images/1258730-68db9c2316407354.png)
...
1. 我想不出比这个更好的（译者：- -||）
2. Dan Abramov使用相同的方法在他的 [redux 中间件](http://redux.js.org/docs/advanced/Middleware.html)实现中
